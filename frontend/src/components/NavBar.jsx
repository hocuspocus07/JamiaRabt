      ...
      >
              ...
              {!isLoggedIn ? (
                ...
                >
                  <Link 
                    to="/signup" 
                    className="flex items-center p-2 space-x-3 rounded-md" 
                    onClick={() => setActiveItem('Login/Signup')}
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 24 24"
        ...
        {isLoggedIn && user && (
          <Link to='/dashboard' className='mt-auto mb-2'>
            <div
              className={`rounded-lg transition-all duration-200 cursor-pointer flex items-center mt-auto space-x-4 ${
                activeItem === 'Profile'
            ...
            >
              <div className="flex-shrink-0">
                <img
                  src={user.avatar || "/profile-pic.png"}
                  alt="profile"
